...
--- | --- 
[**"Appendix Methods: RD Application, Methods and Results.docx"**](./Appendix Methods: RD Application, Methods, and Results.docx) | This document contains the entire walkthrough of our application, including an overview of our application, the steps for conducting an RD analysis, embedded R code, and a summary of the output and results.
